...
DoublyLinkedListNode* sortedInsert(DoublyLinkedListNode* llist, int data)
{
    ...
    DoublyLinkedListNode *add = malloc(sizeof(DoublyLinkedListNode));
    DoublyLinkedListNode *add_p;
    DoublyLinkedListNode *add_n;
    ...
    while (tmp)
    {
        if (tmp ->next && tmp->data <= data && tmp->next->data >= data)
        {
            add_p = tmp->next;
            add_n = tmp;
            add ->prev = add_n;
